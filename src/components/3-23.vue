        ...
        <el-container >
            ...
            <el-aside >
              ...
              <el-main >
                ...
                <ViewThreed></ViewThreed>
                <el-button  color="#626aef" type="primary"   round class="download-button" @click="testt">下载</el-button> 



                <p><span  style="font-size:xx-large;  font-weight:bold; color: cornflowerblue;"  id ="three" class="section">3.处理</span></p>
                <br><br>
